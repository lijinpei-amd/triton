...
class amd_knobs(base_knobs):
    ...
    # SGPR kernarg preload (inreg on kernel args): tri-state override.
    use_kernarg_preload: env_opt_bool = env_opt_bool("TRITON_HIP_ENABLE_KERNARG_PRELOAD")
    ...
    kernarg_preload_max_dwords: env_int = env_int("TRITON_HIP_KERNARG_PRELOAD_MAX_DWORDS", 16)
